...
export class RecievePaymentsCall extends ethereum.Call {
  get inputs(): RecievePaymentsCall__Inputs {
    return new RecievePaymentsCall__Inputs(this);
  }

  get outputs(): RecievePaymentsCall__Outputs {
    return new RecievePaymentsCall__Outputs(this);
  }
}

export class RecievePaymentsCall__Inputs {
  _call: RecievePaymentsCall;

  constructor(call: RecievePaymentsCall) {
    this._call = call;
  }
...
export class RecievePaymentsCall__Outputs {
  _call: RecievePaymentsCall;
